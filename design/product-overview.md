...
**Current focus:** Firefox port, SDK `onchange` API for real-time site adaptation, ecosystem outreach (pilot sites publishing declarations), and store distribution (Chrome and Edge published, Opera in review).
