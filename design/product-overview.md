...
| v0.5.0 | Operating modes (Standalone/ProtoConsent Mode) with capabilities gating, Proto tab dashboard, URL parameter stripping (~300 global + ~1800 site-specific params), blocker detection, block provenance |
| v0.6.0 (dev) | Regional filter lists: 13 language-specific blocking and cosmetic filters from EasyList and AdGuard regional supplements, with language selection in Purpose Settings and preset integration |
