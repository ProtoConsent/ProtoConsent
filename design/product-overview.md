...
**Current focus:** SDK `onchange` API for real-time site adaptation, ecosystem outreach (pilot sites publishing declarations), and store distribution (Edge published, Chrome and Opera in review).
...
| v0.5.6 | Expanded curated blocklists across 6 purpose categories, new security protection category, streamlined Enhanced catalog, CDN cache-busting for list updates, Protection tab visual refresh |
